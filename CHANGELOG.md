...
- Added a cumulative progress tracker above the file list, visible as soon as files are added: a byte-weighted progress bar plus the total size and live counts of done/skipped/error/cancelled files, covering everything added this session across multiple "Upload" rounds, not just the most recent batch ([#17](https://github.com/brain-bbqs/ember-uploader/pull/17))
